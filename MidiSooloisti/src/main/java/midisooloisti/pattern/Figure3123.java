...
/**
 *    Figure3123 toteuttaa Pattern-rajapinnan. Luokka tuottaa tahdin verran nuotteja MidiNote-listana. Nuottikuvio
 *    muodostuu nimensä mukaisesti kuviosta, jossa on kolmea vierekkäistä asteikon ääntä neljän nuotin ryhmissä
 *    järjestettynä siten, että ylin näistä äänistä tulee ensin, sitten hypätään pari ääntä alemmas ja palataan
 *    asteikkoa pitkin lähtöääneen. Viimeinen neljän nuotin ryhmä tehdään variaationa 3212.
 *    Jokaisessa neljän nuotin ryhmässä ensimmäinen ääni on kyseisen asteikon ja sointuasteen sointutääni.
 *    Neljän nuotin ryhmän seuraava sijainti on yhtä sointuääntä ylempänä tai alempana riippuen tahdin alussa
 *    määriteltävästä suuntamuuttujasta. Jos asetetun nuottialueen rajat tulevat vastaan kesken tahdin, vaihdetaan
 *    nuottikuvion etenemissuuntaa.
 */
